...
def _bulk_insert(
    ...
    for table, super_mapper in base_mapper._sorted_tables.items():
        ...
        _emit_insert_statements(base_mapper, None,
                                ...
                                productkeeping=return_defaults)
...
def _emit_update_statements(base_mapper, uowtransaction,
    ...
    for (connection, paramkeys, hasvalue, has_all_defaults, has_all_pks), \
        ...
        elif productkeeping and not has_all_defaults and \
        ...
        if hasvalue:
            ...
            if not allow_multirow:
                ...
                for state, state_dict, params, mapper, \
                    ...
                    # TODO: why with productkeeping=False?
                    if productkeeping:
                        _postfetch(
                            mapper,
                            uowtransaction,
